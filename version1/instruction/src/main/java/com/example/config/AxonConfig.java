...
import com.example.domain.aggregate.BondAggr;
...
public class AxonConfig {
    ...
    @Bean
    public EventSourcingRepository<BondAggr> bondRepository(EventStore eventStore, Cache cache) {
        return EventSourcingRepository.builder(BondAggr.class)
                .cache(cache)
